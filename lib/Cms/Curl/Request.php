 ...
 **/
class Cms_Curl_Request extends Core_Singleton {
	 ...
	 *
	 * Returns a Cms_Curl_Response object if the request was successful, false otherwise
	 *
	 * @param string       $url
	 * @param array|string $vars
	 * @return Cms_Curl_Response object
	 **/
	 ...
	 * @param string       $url
	 * @param array|string $vars
	 * @return Cms_Curl_Response|boolean
	 **/
	...
	function request($method, $url, $vars = array()) {
		...
		if ($response) {
			$response = new Cms_Curl_Response($response);
		} else {
